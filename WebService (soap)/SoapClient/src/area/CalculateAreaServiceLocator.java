...
public class CalculateAreaServiceLocator extends org.apache.axis.client.Service implements area.CalculateAreaService {
    ...
    private java.lang.String CalculateArea_address = "http://localhost:8006/Soap/services/CalculateArea";
    ...
    public area.CalculateArea getCalculateArea() throws javax.xml.rpc.ServiceException {
    ...
    public area.CalculateArea getCalculateArea(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            area.CalculateAreaSoapBindingStub _stub = new area.CalculateAreaSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (area.CalculateArea.class.isAssignableFrom(serviceEndpointInterface)) {
                area.CalculateAreaSoapBindingStub _stub = new area.CalculateAreaSoapBindingStub(new java.net.URL(CalculateArea_address), this);
                _stub.setPortName(getCalculateAreaWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://area", "CalculateAreaService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://area", "CalculateArea"));
        }
