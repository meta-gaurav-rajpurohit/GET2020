...
public class Main_ {
    ...
    public static String selectItem() throws IOException {
        ...
        System.out.println(String.format("%5s %20s %20s", "S.No.",
                "Name of item", "Price of item"));
        for (HashMap.Entry<String, Integer> entry : Item.item.entrySet()) {
            System.out.println(String.format("%5s %20s %20s", ++count,
