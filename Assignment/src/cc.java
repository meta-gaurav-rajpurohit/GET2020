...
public class cc {
			 ...
			 *
			 * @param  item the first {@code String} to add
			 * @param  quantity the second {@code int} to add
			 */
			 ...
			 *
			 * @param  item the first {@code String} to update
			 * @param  quantity the second {@code int} to update
			 */
			 ...
			 *
			 * @param  item the first {@code String} to delete
			 */
			...
			public void showCart(){
				...
				for (HashMap.Entry<String,Integer> entry : cart.entrySet())  
		            System.out.println(String.format("%20s %20s %20s",entry.getKey(),entry.getValue(),(entry.getValue() * rc.getPrice(entry.getKey()))));
			}
